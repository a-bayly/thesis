"""
Code for Experiment 2b [Recovering conditional covariance]
See section 3.8.2 for details. This code generates figures 3.16 which plots the prediction errors for correlation under
the modified covariance model - see equation 3.46 in the thesis.
"""
...
class GaussianConditionalCovariance(datasetXY):
    def __init__(self, sample_size):
        """
        Generates Gaussian Conditional Covariance data in second model - see section 3.8.2 in thesis and equation 3.46
        ...
        for i in range(self.Y.shape[0]):
            s = 1 + np.abs(self.X[i,:]) # Modification to data generating model
...
NCP_trainer.learning_kwargs['scaling'] = True # Appears to learn garbage without scaled variables as input
NCP_trainer.learning_kwargs['hidden_layers'] = 2*[64]
NCP_trainer.training_kwargs['max_epochs'] = int(5000)
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
Plot prediction benchmark diagnostics [generates Figure 3.16]
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
